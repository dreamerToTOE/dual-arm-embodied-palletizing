...
2026-09-09，使用 `task08_conflict` 默认 scenario 完成实际 Isaac + MoveIt 联调：

```text
horizon         = 19.117 s
sample_period   = 0.010 s
samples_checked = 289
detector_wall   = 0.045 s

Task08-B CONFLICT: first_time = 2.880 s
pair = left_fr3_link7 <-> right_fr3_link7
type = ARM_ARM
Task08-B PASS
```
