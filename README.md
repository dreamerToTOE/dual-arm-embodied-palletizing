...
| 22 | Ground Truth 在线任务分派与预规划 | 🟡 Task22-A Ground Truth → Task19 candidates → Python typed dispatch 已通过只读回归；Task22-B primary-arm-first MoveIt/FCL 预检已构建、待真实规划验收，复用 Task08/09 冲突协调 |
