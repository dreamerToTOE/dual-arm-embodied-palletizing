...
# 供料区不属于密集码垛区。二指夹爪在 OPEN 时需要侧向接近净空，因此供料
# Cube 的中心距固定为 120 mm；原先 45 mm 网格会让 finger 在抓取第一件时
# 碰到相邻供料 Cube，无法验证“暂存后平推”本身。
#
# Supply_01 仍保留在已验证可达的 (0.240, -0.300)；其余位置仅作为串行供料。
SUPPLY_X = (0.240, 0.360, 0.480, 0.120)
SUPPLY_Y = (-0.300, -0.180, -0.060, 0.060)
